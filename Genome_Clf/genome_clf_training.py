...
# Parse config
cfg_model = config['DDcDNA']["Reformer"]
cfg_training = config['DDcDNA']['training']
...
# Read the data
data = torch.load('./data/DDcDNA16384_train.pt').to(torch.int64)
labels = torch.load('./data/DDcDNA16384_train_targets.pt').to(torch.int64)

data_val = torch.load('./data/DDcDNA16384_val.pt').to(torch.int64)
labels_val = torch.load('./data/DDcDNA16384_val_targets.pt').to(torch.int64)

data_test = torch.load('./data/DDcDNA16384_test.pt').to(torch.int64)
labels_test = torch.load('./data/DDcDNA16384_test_targets.pt').to(torch.int64)
